...
class CreditMemoDocumentLinesItemAdapter(private val onSave: (
    ArrayList<ArInvoiceListModel.Value.DocumentLine>
) -> Unit) :
    ListAdapter<ArInvoiceListModel.Value.DocumentLine,
            CreditMemoDocumentLinesItemAdapter.ViewHolder>(DiffCallback()) {
    ...
    class ViewHolder(
        ...
        fun bind(item: ArInvoiceListModel.Value.DocumentLine) = with(binding) {
    ...
    class DiffCallback : DiffUtil.ItemCallback<ArInvoiceListModel.Value.DocumentLine>() {
        override fun areItemsTheSame(
            old: ArInvoiceListModel.Value.DocumentLine,
            new: ArInvoiceListModel.Value.DocumentLine
        ) =
